    ...
    <div className="ba-section">
      ...
      <div className="ba-text-content">
        <h3 className="ba-title">
          <span>Why Choose Christian Mission</span>
        </h3>
        <p className="ba-description">
          Discover the reasons to choose Christian Mission Hospital for your healthcare needs.
        ...
        <p className="ba-checks">
          <FontAwesomeIcon icon={faCircleCheck} style={{ color: "#1E8FFD" }} /> 24/7 Call Support
        </p>
