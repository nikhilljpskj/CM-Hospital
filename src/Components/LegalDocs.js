    ...
    <div className="legal-section-title">
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to Christian Mission Hospital, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          When using Christian Mission Hospital, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          Christian Mission Hospital is designed to simplify healthcare access. You can choose
